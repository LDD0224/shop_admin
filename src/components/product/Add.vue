  ...
  <div class="goods-add">
    ...
    <el-tabs @tab-click="change" v-model="activeName" tab-position="left">
      <el-tab-pane name="basic" label="基本信息">
        <el-form :model="addForm" label-width="80px">
          ...
          <el-form-item label="是否促销">
            <el-radio :label="true" v-model="addForm.is_promote">是</el-radio>
            <el-radio :label="false" v-model="addForm.is_promote">否</el-radio>
          </el-form-item>
          <el-form-item>
      ...
      <el-tab-pane name="pic" label="商品图片">
        ...
        list-type="picture" :headers="headers" :on-success="handerSuccess">
